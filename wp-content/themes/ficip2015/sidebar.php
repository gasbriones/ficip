<aside class="small-3 columns right sidebar">
   ...
   <a 	href="<?php the_permalink(); ?>" title="Ir al artículo <?php the_title(); ?>">
	...
	<ul class="banners">
			...
			<li><a href="<?php bloginfo('url'); ?>/?cat=5" title="Jurados del festival" ><img src="<?php bloginfo('template_url'); ?>/images/jurados.png" alt="" /></a></li>
			<li><a href="<?php bloginfo('url'); ?>/?page_id=140" title="Prensa, material y acreditaciones" ><img src="<?php bloginfo('template_url'); ?>/images/prensa.png" alt="" /></a></li>
			<li><a href="http://ficip2013.com.ar" title="Ediciones Anteriores" target="_blank"><img src="<?php bloginfo('template_url'); ?>/images/ediciones-anteriores.png" alt="" /></a></li>
	</ul>
