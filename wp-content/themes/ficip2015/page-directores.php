...
<section id="page" class="small-9 columns infinite-scroll directores">
      ...
      $query1 = new WP_Query($args1);
   	...
   	<article style="margin-bottom:2em;" class="row">
			   ...
			   <div class="small-8 columns">
				   <a href="<?php the_permalink(); ?>" title="<?php the_field('nombre_del_director_de_la_pelicula'); ?>"><h2> <?php the_field('nombre_del_director_de_la_pelicula'); ?></h2></a>
