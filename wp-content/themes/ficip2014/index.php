...
<?php get_sidebar(); ?>
	...
	<section class="small-9 columns left conferencias">
		...
		<a href="<?php bloginfo('url'); ?>/?cat=15" class="all_conf" title="Ver todas las conferencias y actividades especiales">Ver todas las conferencias y actividades especiales</a>
